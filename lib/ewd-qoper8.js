...
var qoper8 = function(params) {
  ...
  //this.queue = [];
  var maxq = 20000;
  if (params && params.max_queue_length) {
    maxq = params.max_queue_length;
  }
  this.queue = new deq(maxq);
  ...
  this.on('workerStarted', function(pid, customQueue) {
    ...
    if (customQueue || !this.queue.isEmpty()) this.processQueue(customQueue);
  });
